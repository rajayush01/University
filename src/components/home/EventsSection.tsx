				...
				{(Object.keys(allInfoData) as DepartmentType[]).map((key, idx) => {
					...
					return (
						...
						>
							...
							{/* Title */}
							<h3 className="text-xl font-semibold p-4 border-b text-blue-700 bg-white sticky top-0 z-10">
								{dept.title}
							</h3>
									...
									return (
										...
										>
											...
											<motion.span
												...
												className="absolute inset-0 bg-blue-900/80 origin-left z-0"
											/>
							...
							<motion.button
								...
								whileTap={{ scale: 0.92 }}
								className="relative overflow-hidden bg-blue-700 text-white py-3 font-medium flex items-center justify-center gap-2"
							>
								{/* Shimmer */}
